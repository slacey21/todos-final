...
app.post("/lists",
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      let created = store.createdTodoList(todoListTitle);
      if (!created) {
...
app.get("/lists/:todoListId", (req, res, next) => {
  ...
  if (todoList === undefined) {
    ...
    let todos = store.sortedTodos(todoList);
...
app.post("/lists/:todoListId/todos/:todoId/toggle", (req, res, next) => {
  ...
  if (!todo) {
    ...
    store.toggleTodo(+todoListId, +todoId);
...
app.post("/lists/:todoListId/complete_all", (req, res, next) => {
  let todoListId = req.params.todoListId;
  let store = res.locals.store;
  let todosMarkedDone = store.completeAllTodos(+todoListId);
  ...
  (req, res, next) => {
    ...
    if (!todoList) {
      ...
      if (!errors.isEmpty()) {
        ...
        let created = store.addedTodo(+todoListId, todoTitle);
